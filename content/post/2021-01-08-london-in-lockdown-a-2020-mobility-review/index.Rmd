...
We see the usage of the transport services as a percent change of the previous year. To interpret this, as an example, on the 19th August 2020, the percent change for the tube was -75%, meaning that day saw only 25% of the number of people using the tube from 2019 in 2020 on that specific day.
...
* There is a brief recovery as the 2nd lockdown is eased, however it is short-lived as London is once again forced into restrictions by being placed at tier 3, while then being upgraded to the worse tier 4 level only a few day days. Tier 4 is essentially a lockdown, but on a local level rather than a national one. The restrictions led to a decline in passenger numbers from the same time last year.

We can compare how the passengers numbers changed from the baseline during the two lockdowns, in particular, the numbers changing during the weekday and weekends. It is important to do this as the behaviour and movement of people is influenced by the day of week; a simple example is many people travelling to work on Monday to Friday, but not Saturday or Sunday.
...
We can interpret the plot as the following: For transit stations on the 11th March, the percent change was -75% from the baseline value. This means that the number of people at the park only 25% of the day of week average in the period 3rd Jan - 6 Feb 2020.
...
* There was an element of panic buying before the first lockdown, where the number of people spent at groceries and pharmacies was around 30% higher than the baseline average for the population of London. There has been a steady increase since the first lockdown, but the numbers at these locations has never fully recovered to pre-pandemic levels, except for Christmas holiday season. 

    This exception is likely due to London being placed on into tier 4 during Christmas, which forced individuals to celebrate Christmas with fewer people, thereby leading to a slight increase in visits to supermarkets as more people are buying food for their own Christmas party.
...
* Retail and Recreation took a severe blow when the lockdowns were enforced. The first lockdown saw a 75% drop in the number of people at these locations when compared to the baseline.
    ...
    There was a spike before the second lockdown before the average percent change decrease to about 63% from the baseline. There was a brief recovery after the second lockdown, but the percent change steadly declined for the rest of the year. 
...
Essentially, the trend appears to suggest that Londoner are going back to pre-pandemic behaviour. Is this a hint of lockdown fatigue? 

As of this blog post being written, London is currently in its 3rd lockdown and there has been some concern, especially amongst leaders in Government and senior academic advisors, that people are not adhering to the rules as much. Perhaps some in another blog post I will look to see the differences between the 3 lockdowns.
...
It's also worth remembering that the baseline is a measure of the average spent, not number of people. And since there are only so many hours in the day, we should expect small changes, like on weekends where people aren't going to work.
...
For retail and recreation locations, we see a similar picture for the other locations, where the inner boroughs were deserted, and the outer ones saw more activity.
...
While many boroughs followed the same trend, there is one one oddity; the borough of Camden has much lower levels of shopping than the other boroughs compared. During the Summer, it was just under a 50% decrease, while many of the other boroughs add a percent decrease of 25%.
...
It appears that, once again, the percent change did not recover as much in central London as it did anywhere else. Where central London only just reach over 50% of pre-pandemic levels, other boroughs saw usage recover to nearly 75% of pre-pandemic levels.
...
* Locations such as workplaces, groceries, pharmacies saw a dramatic reduction from the baseline during the year
